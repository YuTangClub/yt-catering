...
public class MatrixToImageWriter {
    ...
    private static BufferedImage addBackImg(BufferedImage destImage, String realPath) throws IOException {
        ...
        g.drawImage(image,(bg.getWidth()- width)/2-310,(bg.getHeight()-height)/2+30,width,height,null);
        g.dispose();
        bg.flush();
        image.flush();
...
//                "C:\\Users\\jinyefei\\Desktop\\logo.png", "C:\\Users\\jinyefei\\Desktop\\2018-04.png");
//
//
//
//    }
